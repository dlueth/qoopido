...
describe("emit()", () => {
    test("should emit an event without additional parameters", () => {
        return new Promise((resolve, reject) => {
            ...
            emitter.on(unique, listener).emit(unique);
...
describe("on()", () => {
    ...
    test("should call an string listener repeatedly", () => {
        return new Promise((resolve, reject) => {
            ...
            emitter.on(unique, listener).emit(unique).emit(unique).emit(unique);
    ...
    test("should call an array of listeners repeatedly", () => {
        return new Promise((resolve, reject) => {
            ...
            emitter.on([unique, unique], listener).emit(unique).emit(unique);
...
describe("once()", () => {
    test("should call a string listener only once", () => {
        return new Promise((resolve, reject) => {
            ...
            emitter.once(unique, listener).emit(unique).emit(unique);
    ...
    test("should call an array of listeners only once", () => {
        return new Promise((resolve, reject) => {
            ...
            emitter.once([unique, unique], listener).emit(unique).emit(unique);
...
describe("off()", () => {
    test("should silently fail for invalid identifier", () => {
        ...
        emitter.on(unique, listener).off({}, listener);
    ...
    test("should not unregister expression listener when removing a string listener", () => {
        return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
                try {
                    expect(listener.mock.calls.length).toBe(3);
                    expect(emitter.listener(unique + "/success").length).toBe(
                        1
                    );
